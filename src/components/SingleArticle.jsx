  ...
  return (
    <section>
      ...
      >
        ...
        <Card.Body>
          <Card.Text>
            <label className="card-label">Topic: </label> {article.topic}
          </Card.Text>
          <Card.Text>{article.body}</Card.Text>
          <Card.Text>
            <label className="card-label">Author: </label> {article.author}
          </Card.Text>
          <Card.Text>
            <Votes votes={article.votes} article_id={article.article_id} />
          </Card.Text>
          <Card.Text>
            <label className="card-label">Comments: </label>{" "}
            {article.comment_count}
          </Card.Text>
          <Card.Text>
            <label className="card-label">Date posted: </label>{" "}
